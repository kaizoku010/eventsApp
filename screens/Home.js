...
<Text style={styles.ticketTime}>{attendeesData?.eventTime}</Text>
...
<Text style={styles.ticketDate}>{attendeesData?.eventLocation}</Text>  
      ...
      <ImageBackground
        ...
        resizeMode="cover"
      >
        {/* Add any content for the bottom view here */}
...
export default connect(mapStateToProps, { fetchAttendeesAndEvents })(Home);
    ...
    //       srcSet={attendeesData?.eventGraphicsURL || ''}
    //     />
    //     <View style={styles.profileContainer}>
    //       <Image style={styles.profilePhoto} srcSet={imagePath} />
    ...
    //       <Text style={styles.statCount}>{email}</Text>
    //     </View>
    //     <View style={styles.statContainer}>
    //       <Text style={styles.statLabel}>Event ID</Text>
    //       <Text style={styles.statCount}>{attendeesData?.id}</Text>
    //     </View>
    //     <View style={styles.statContainer}>
    //       <Text style={styles.statLabel}>Event Name</Text>
    //       <Text style={styles.statCount}>{attendeesData?.eventName || "loading"}</Text>
    //     </View>
        
    //   </View>
    //   <View style={styles.newCont2}>
     
    //     <View style={styles.statContainer}>
    //       <Text style={styles.statLabel}>Occupation</Text>
    //       <Text style={styles.statCount2}>{userData?.occupation}</Text>
    //     </View>
    //     <View style={styles.statContainer}>
    //       <Text style={styles.statLabel}>Position </Text>
    //       <Text style={styles.statCount2}>{userData?.office || "loading"}</Text>
    //     </View>
    //     <View style={styles.statContainer}>
    //      </View>
